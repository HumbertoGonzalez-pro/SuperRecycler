...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listaPaises.add(Pais(nombre = "Mexico.!", imagen = "https://bit.ly/2UAJnh0"))
        listaPaises.add(Pais(nombre ="Estados Unidos.!", imagen = "https://bit.ly/32QjRck"))
        listaPaises.add(Pais(nombre ="Venezuela.!", imagen = "https://bit.ly/32Sliqx"))
        listaPaises.add(Pais(nombre ="Peru.!", imagen = "https://bit.ly/35EnpQN"))
